...
console.log(exclaimThree("arrow function"));
...
const nameCheck = (nameParam) => {
  return nameParam === "Steven"
    ? "What is up Steven?"
    : nameParam === "Bryan"
    ? "Hey Bryan!"
    : `Cool name, ${nameParam}`;
};
let nameGreeting = nameCheck("Asel");
...
const bigOrSmall = (arr) => {
  let answers = [];
  for (let el of arr) {
    el > 100 ? answers.push("big") : answers.push("small");
  }
  return answers;
};
...
console.log(emailCheck("asel@gmail.com"));
////////////////// PROBLEM 19 ////////////////////
/*
...
//CODE HERE
const canAfford = (gold) => {
  return gold / 3;
};
const totalFrogs = canAfford(27);
...
let bathroomScope = [];
bathroomScope.push("squeky", duck) 
console.log(bathroomScope)

//This array should contain the variable names (as strings) accessible in the bathtub function.
let bathtubScope = [];
bathtubScope.push('squeky', 'nautical', duck) //'squeky is accessible to bathtub because of closure. 'cute' is a global var.
console.log(bathtubScope)

//This array should contain the variable names (as strings) accessible in the pond function.
let pondScope = [];
pondScope.push('fluffy', duck)
